...
sublaby("   ");
print -dpng images\gamma_full_degrau\fig09a.png
...
legend({par1,par2,par3,par4,'$\theta_1^*$','$\theta_2^*$'},...
    'FontSize',8,'Interpreter','latex','Location','NorthEast')
sublaby("   ");
print -dpng images\gamma_full_degrau\fig09b.png
...
V = axis;
axis([V(1) V(2) 0 2.5 ]);
print -dpng images\gamma_full_degrau\fig09c.png
...
sublaby("   ");
print -dpng images\gamma_full_degrau\fig09d.png
...
legend({par1,par2},...
    'FontSize',8,'Interpreter','latex','Location','SouthEast')
sublaby("   ");
print -dpng images\gamma_full_degrau\fig09e.png
