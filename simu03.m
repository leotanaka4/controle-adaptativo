...
par3 = strcat('$y(0)=',num2str(yp0),', \gamma=',num2str(gamma1),'$');
par4 = strcat('$y(0)=',num2str(yp0),', \gamma=',num2str(gamma2),'$');
par5 = strcat('$y(0)=',num2str(-yp0),', \gamma=',num2str(gamma1),'$');
par6 = strcat('$y(0)=',num2str(-yp0),', \gamma=',num2str(gamma2),'$');
legend({par3,par4,par5,par6},...
    'FontSize',8,'Interpreter','latex','Location','NorthEast')
print -depsc2 fig03d.eps
